...
$pathtonuspec = Join-Path $scriptDir Melad.CleanArchitecture.Template.nuspec
...
$pathtonupkg = join-path $scriptDir nupkg/Melad.CleanArchitecture.Template.1.0.4.nupkg
